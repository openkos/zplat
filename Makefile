...
swag:
	swag init --dir cmd/server --exclude client

client: swag
	swagger-codegen generate -i docs/swagger.json -l go -DpackageName=client -o client

jssdk: swag
	swagger-codegen generate -i docs/swagger.json -l javascript -DprojectName=zplat-jssdk --additional-properties usePromises=true,useES6=true -o ../zplat-jssdk
